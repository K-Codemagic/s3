...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="s3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSApplication;

SWIFT_CLASS("_TtC2s311AppDelegate")
...
SWIFT_CLASS("_TtC2s317MainFlutterWindow")
